...
public class WallOfFireEntity extends AbstractShieldEntity {
    ...
    public WallOfFireEntity(Level level, Entity owner, PlayerMagicData playerMagicData) {
        this(EntityRegistry.WALL_OF_FIRE_ENTITY.get(), level);
        createShield(playerMagicData);
        setOwner(owner);
    }
...
//        }
    ...
    @Override
    public void createShield(PlayerMagicData playerMagicData) {
        if(playerMagicData.getAdditionalCastData() instanceof WallOfFireSpell.FireWallData fireWallData){
