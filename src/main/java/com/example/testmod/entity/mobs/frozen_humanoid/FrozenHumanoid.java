package com.example.testmod.entity.mobs.frozen_humanoid;
...
//    }
    ...
    public FrozenHumanoid(Level level, LivingEntity entityToCopy) {
        ...
        //TestMod.LOGGER.debug("yRot: {}", entityToCopy.getYRot());
        //TestMod.LOGGER.debug("yBodyRot: {}", entityToCopy.yBodyRot);
...
//        this.setOldPosAndRot();
        ...
        TestMod.LOGGER.debug("Entity limbSwing: {}", entityToCopy.animationPosition);
        TestMod.LOGGER.debug("Entity limbSwingAmount: {}", entityToCopy.animationSpeed);
        //TestMod.LOGGER.debug("My limbSwing: {}", limbSwing);
//
//        this.entityData.set(DATA_FROZEN_SPEED, speed);
//        TestMod.LOGGER.debug("{}", speed);
