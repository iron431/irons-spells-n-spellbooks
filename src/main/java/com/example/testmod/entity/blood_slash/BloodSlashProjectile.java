...
//            return;
//        }
//        //TestMod.LOGGER.debug("Increasing Radius");
//        oldDimensions = getBoundingBox();
...
//            TestMod.LOGGER.debug(entity.getName().getString());
//        }
...
//        //TestMod.LOGGER.debug("Accessing Blood Slash Dimensions. Age: {}", age);
//        this.getBoundingBox();
//        return EntityDimensions.scalable(this.getRadius() + 2.0F, 0.5F);
//    }
//
//    public void onSyncedDataUpdated(EntityDataAccessor<?> p_19729_) {
//        //TestMod.LOGGER.debug("onSynchedDataUpdated");
//
