package com.example.testmod.entity.wisp_projectile;
...
public class WispProjectileRenderer extends EntityRenderer<WispProjectile> {
...
//    };
    ...
    public WispProjectileRenderer(Context context) {
        super(context);
    }

    @Override
    public void render(WispProjectile entity, float yaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int light) {
        poseStack.pushPose();
    ...
    private void drawSlash(Pose pose, WispProjectile entity, MultiBufferSource bufferSource, int light, float width, int offset) {
        Matrix4f poseMatrix = pose.pose();
        Matrix3f normalMatrix = pose.normal();
    ...
    @Override
    public ResourceLocation getTextureLocation(WispProjectile entity) {
        int frame = (entity.animationTime / 4) % TEXTURES.length;
        return TEXTURES[frame];
        //return TEXTURE;
    }

    private ResourceLocation getTextureLocation(WispProjectile entity, int offset) {
