...
public class WispProjectile extends Projectile {
    private static final EntityDataAccessor<Float> DATA_RADIUS = SynchedEntityData.defineId(WispProjectile.class, EntityDataSerializers.FLOAT);
    ...
    public WispProjectile(EntityType<? extends WispProjectile> entityType, Level level) {
    ...
    public WispProjectile(EntityType<? extends WispProjectile> entityType, Level levelIn, LivingEntity shooter) {
    ...
    public WispProjectile(Level levelIn, LivingEntity shooter) {
        this(EntityRegistry.WISP_PROJECTILE.get(), levelIn, shooter);
    }
