...
public class CreateImbuedSwordCommand {
    ...
    private static final SimpleCommandExceptionType ERROR_FAILED = new SimpleCommandExceptionType(Component.translatable("commands.testmod.create_imbued_sword.failed"));
