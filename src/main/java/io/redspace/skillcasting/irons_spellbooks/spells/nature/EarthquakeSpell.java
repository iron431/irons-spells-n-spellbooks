...
public class EarthquakeSpell extends AbstractSpellSkill {
    ...
    public List<MutableComponent> getUniqueInfo(CastContext castContext) {
        return List.of(
                Component.translatable("ui.irons_spellbooks.aoe_damage",
                        Utils.stringTruncation(castContext.getOrDefault(SkillcastingComponentTypes.AOE_DAMAGE, 0f), 2)),
    ...
    public void buildContextComponents(CastContext castContext) {
        ...
        castContext.set(SkillcastingComponentTypes.AOE_DAMAGE, damage);
    ...
    public void onCast(ServerLevel level, CastContext castContext) {
        ...
        aoeEntity.setDamage(castContext.getOrDefault(SkillcastingComponentTypes.AOE_DAMAGE, 0f));
