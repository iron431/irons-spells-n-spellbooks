...
public class SoundRegistry {
    ...
    public static RegistryObject<SoundEvent> TOUCH_DIG_CAST = registerSoundEvent("spell.touch_dig.cast");
    ...
    public static RegistryObject<SoundEvent> RAISE_HELL_PREPARE = registerSoundEvent("spell.raise_hell.prepare");
    public static RegistryObject<SoundEvent> FIERY_DAGGER_THROW = registerSoundEvent("entity.fiery_dagger.throw");
    public static RegistryObject<SoundEvent> FIRE_DAGGER_PARRY = registerSoundEvent("entity.fiery_dagger.parry");
    public static RegistryObject<SoundEvent> SOULCALLER_TOLL_SUCCESS = registerSoundEvent("item.cinderous_soulcaller.toll.success");
    public static RegistryObject<SoundEvent> SOULCALLER_TOLL_FAILURE = registerSoundEvent("item.cinderous_soulcaller.toll.failure");
    public static RegistryObject<SoundEvent> GENERIC_BLADE_SWING = registerSoundEvent("entity.generic.swing_blade");
    public static RegistryObject<SoundEvent> SUMMONED_SWORDS_CHARGE = registerSoundEvent("spell.summon_swords.charge");
    public static RegistryObject<SoundEvent> SUMMONED_SWORDS_CAST = registerSoundEvent("spell.summon_swords.cast");
    public static RegistryObject<SoundEvent> POCKET_DIMENSION_TRAVEL = registerSoundEvent("spell.pocket_dimension.travel");
    public static RegistryObject<SoundEvent> ELDRITCH_PREPARE = registerSoundEvent("cast.generic.eldritch_prepare");
    public static RegistryObject<SoundEvent> ICE_SPIDER_HURT = registerSoundEvent("entity.ice_spider.hurt");
    public static RegistryObject<SoundEvent> ICE_SPIDER_BITE = registerSoundEvent("entity.ice_spider.bite");
    public static RegistryObject<SoundEvent> ICE_SPIDER_GRAPPLE_LATCH = registerSoundEvent("entity.ice_spider.grapple_latch");
    public static RegistryObject<SoundEvent> ICE_SPIDER_GRAPPLE_SPIT = registerSoundEvent("entity.ice_spider.grapple_spit");
    public static RegistryObject<SoundEvent> ICE_SPIDER_DEATH = registerSoundEvent("entity.ice_spider.death");
    public static RegistryObject<SoundEvent> ICE_SPIDER_AMBIENT = registerSoundEvent("entity.ice_spider.ambient");
    public static RegistryObject<SoundEvent> ICE_SPIDER_HOWL = registerSoundEvent("entity.ice_spider.howl");
    ...
    public static RegistryObject<SoundEvent> SPEAR_RETURN = registerSoundEvent("item.spear.loyalty_return");
    public static RegistryObject<SoundEvent> SPEAR_CHANNELING_STRIKE = registerSoundEvent("item.spear.channeling_strike");
    public static RegistryObject<SoundEvent> SHADOW_SLASH = registerSoundEvent("spell.shadow_slash.cast");
    ...
    public static RegistryObject<SoundEvent> FIRE_BOSS_HURT = registerSoundEvent("entity.fire_boss.hurt");
    public static RegistryObject<SoundEvent> FIRE_BOSS_DEATH = registerSoundEvent("entity.fire_boss.death");
    public static RegistryObject<SoundEvent> FIRE_BOSS_ACCENT = registerSoundEvent("entity.fire_boss.death_final");
    public static RegistryObject<SoundEvent> FIRE_BOSS_TRANSITION_SOUL = registerSoundEvent("entity.fire_boss.enter_soul");
    public static RegistryObject<SoundEvent> FIRE_BOSS_SUMMON_SCYTHE = registerSoundEvent("entity.fire_boss.summon_scythe");
    public static RegistryObject<SoundEvent> FIRE_BOSS_FIREBALL = registerSoundEvent("entity.fire_boss.fireball");
    public static RegistryObject<SoundEvent> MUSIC_FIRE_BOSS_MELODY_A = registerSoundEvent("music.fire_boss.melody_a");
    public static RegistryObject<SoundEvent> MUSIC_FIRE_BOSS_MELODY_B = registerSoundEvent("music.fire_boss.melody_b");
    public static RegistryObject<SoundEvent> MUSIC_FIRE_BOSS_BELLS_A = registerSoundEvent("music.fire_boss.bells_a");
    public static RegistryObject<SoundEvent> MUSIC_FIRE_BOSS_BELLS_B = registerSoundEvent("music.fire_boss.bells_b");
    public static RegistryObject<SoundEvent> MUSIC_FIRE_BOSS_BACKTRACK = registerSoundEvent("music.fire_boss.backtrack");
    public static RegistryObject<SoundEvent> MUSIC_FIRE_BOSS_DRUMS = registerSoundEvent("music.fire_boss.drums");
    ...
    public static RegistryObject<SoundEvent> MUSIC_DISC_DEAD_KING_LULLABY = registerSoundEvent("music.dead_king_lullaby");
    public static RegistryObject<SoundEvent> MUSIC_DISC_FLAME_STILL_BURNS = registerSoundEvent("music.flame_still_burns");
    public static RegistryObject<SoundEvent> MUSIC_DISC_WHISPERS_OF_ICE = registerSoundEvent("music.whispers_of_ice");

    public static final RegistryObject<SoundEvent> VAULT_ACTIVATE = registerSoundEvent("block.vault.activate");
    public static final RegistryObject<SoundEvent> VAULT_AMBIENT = registerSoundEvent("block.vault.ambient");
    public static final RegistryObject<SoundEvent> VAULT_BREAK = registerSoundEvent("block.vault.break");
    public static final RegistryObject<SoundEvent> VAULT_CLOSE_SHUTTER = registerSoundEvent("block.vault.close_shutter");
    public static final RegistryObject<SoundEvent> VAULT_DEACTIVATE = registerSoundEvent("block.vault.deactivate");
    ...
    public static final RegistryObject<SoundEvent> VAULT_PLACE = registerSoundEvent("block.vault.place");
    public static final RegistryObject<SoundEvent> VAULT_STEP = registerSoundEvent("block.vault.step");
