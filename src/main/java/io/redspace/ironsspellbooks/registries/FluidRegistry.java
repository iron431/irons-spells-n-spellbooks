...
public class FluidRegistry {
    ...
    public static final RegistryObject<Fluid> BLOOD = registerNoop("blood", BLOOD_TYPE::value);
    public static final RegistryObject<Fluid> COMMON_INK = registerNoop("common_ink", COMMON_INK_TYPE::value);
    public static final RegistryObject<Fluid> UNCOMMON_INK = registerNoop("uncommon_ink", UNCOMMON_INK_TYPE::value);
    public static final RegistryObject<Fluid> RARE_INK = registerNoop("rare_ink", RARE_INK_TYPE::value);
    public static final RegistryObject<Fluid> EPIC_INK = registerNoop("epic_ink", EPIC_INK_TYPE::value);
    public static final RegistryObject<Fluid> LEGENDARY_INK = registerNoop("legendary_ink", LEGENDARY_INK_TYPE::value);
    public static final RegistryObject<Fluid> POTION_FLUID = registerNoop("potion", POTION_FLUID_TYPE::value);
    public static final RegistryObject<Fluid> OAKSKIN_ELIXIR_FLUID = registerNoop("oakskin_elixir", OAKSKIN_ELIXIR_TYPE::value);
    public static final RegistryObject<Fluid> GREATER_OAKSKIN_ELIXIR_FLUID = registerNoop("greater_oakskin_elixir", GREATER_OAKSKIN_ELIXIR_TYPE::value);
    public static final RegistryObject<Fluid> INVISIBILITY_ELIXIR_FLUID = registerNoop("invisibility_elixir", INVISIBILITY_ELIXIR_TYPE::value);
    public static final RegistryObject<Fluid> GREATER_INVISIBILITY_ELIXIR_FLUID = registerNoop("greater_invisibility_elixir", GREATER_INVISIBILITY_ELIXIR_TYPE::value);
    public static final RegistryObject<Fluid> EVASION_ELIXIR_FLUID = registerNoop("evasion_elixir", EVASION_ELIXIR_TYPE::value);
    public static final RegistryObject<Fluid> GREATER_EVASION_ELIXIR_FLUID = registerNoop("greater_evasion_elixir", GREATER_EVASION_ELIXIR_TYPE::value);
    public static final RegistryObject<Fluid> GREATER_HEALING_ELIXIR_FLUID = registerNoop("greater_healing_elixir", GREATER_HEALING_ELIXIR_TYPE::value);
    public static final RegistryObject<Fluid> TIMELESS_SLURRY_FLUID = registerNoop("timeless_slurry", TIMELESS_SLURRY_TYPE::value);
    public static final RegistryObject<Fluid> ICE_VENOM_FLUID = registerNoop("ice_venom", ICE_VENOM_TYPE::value);

    private static RegistryObject<Fluid> registerNoop(String name, Supplier<FluidType> fluidType) {
        RegistryObject<Fluid> holder = DeferredHolder.create(Registries.FLUID, IronsSpellbooks.id(name));
