...
public class MobEffectRegistry {
    ...
    public static final RegistryObject<MobEffect> MAGIC_AURA = MOB_EFFECT_DEFERRED_REGISTER.register("magic_aura", () -> new MagicAuraEffect(MobEffectCategory.HARMFUL, 16239960));
}
