...
//                    .eyeHeight(2.3f)
    ...
    public static final RegistryObject<EntityType<IceSpikeEntity>> ICE_SPIKE =
            ENTITIES.register("ice_spike", () -> EntityType.Builder.<IceSpikeEntity>of(IceSpikeEntity::new, MobCategory.MISC)
                    .sized(1f, 2f)
                    .clientTrackingRange(64)
                    .build(ResourceLocation.fromNamespaceAndPath(IronsSpellbooks.MODID, "ice_spike").toString()));

    public static final RegistryObject<EntityType<FireArrowProjectile>> FIRE_ARROW_PROJECTILE =
            ENTITIES.register("fire_arrow", () -> EntityType.Builder.<FireArrowProjectile>of(FireArrowProjectile::new, MobCategory.MISC)
                    .sized(.8f, .8f)
                    .clientTrackingRange(64)
                    .build(ResourceLocation.fromNamespaceAndPath(IronsSpellbooks.MODID, "fire_arrow").toString()));
    ...
    public static final RegistryObject<EntityType<FireEruptionAoe>> FIRE_ERUPTION_AOE =
            ENTITIES.register("fire_eruption", () -> EntityType.Builder.<FireEruptionAoe>of(FireEruptionAoe::new, MobCategory.MISC)
                    .sized(4f, .8f)
                    .clientTrackingRange(64)
                    .build(ResourceLocation.fromNamespaceAndPath(IronsSpellbooks.MODID, "fire_eruption").toString()));

    public static final RegistryObject<EntityType<FieryDaggerEntity>> FIERY_DAGGER_PROJECTILE =
            ENTITIES.register("fiery_dagger", () -> EntityType.Builder.<FieryDaggerEntity>of(FieryDaggerEntity::new, MobCategory.MISC)
                    .sized(.5f, .5f)
                    .clientTrackingRange(64)
                    .build(ResourceLocation.fromNamespaceAndPath(IronsSpellbooks.MODID, "fiery_dagger").toString()));

    public static final RegistryObject<EntityType<CursedArmorStandEntity>> CURSED_ARMOR_STAND =
            ENTITIES.register("cursed_armor_stand", () -> EntityType.Builder.of(CursedArmorStandEntity::new, MobCategory.MONSTER)
                    .sized(.6f, 1.8f)
                    .clientTrackingRange(64)
                    .build(ResourceLocation.fromNamespaceAndPath(IronsSpellbooks.MODID, "cursed_armor_stand").toString()));

    public static final RegistryObject<EntityType<ThunderstepProjectile>> THUNDERSTEP_PROJECTILE =
            ENTITIES.register("thunderstep_orb", () -> EntityType.Builder.<ThunderstepProjectile>of(ThunderstepProjectile::new, MobCategory.MISC)
                    .sized(.5f, .5f)
                    .clientTrackingRange(64)
                    .build(ResourceLocation.fromNamespaceAndPath(IronsSpellbooks.MODID, "thunderstep_orb").toString()));

    public static final RegistryObject<EntityType<SummonedSwordEntity>> SUMMONED_SWORD =
            ENTITIES.register("summoned_sword", () -> EntityType.Builder.<SummonedSwordEntity>of(SummonedSwordEntity::new, MobCategory.MISC)
                    .sized(1f, 1f)
                    .clientTrackingRange(64)
                    .build(ResourceLocation.fromNamespaceAndPath(IronsSpellbooks.MODID, "summoned_sword").toString()));

    public static final RegistryObject<EntityType<SummonedClaymoreEntity>> SUMMONED_CLAYMORE =
            ENTITIES.register("summoned_claymore", () -> EntityType.Builder.<SummonedClaymoreEntity>of(SummonedClaymoreEntity::new, MobCategory.MISC)
                    .sized(1f, 1f)
                    .clientTrackingRange(64)
                    .build(ResourceLocation.fromNamespaceAndPath(IronsSpellbooks.MODID, "summoned_claymore").toString()));

    public static final RegistryObject<EntityType<SummonedRapierEntity>> SUMMONED_RAPIER =
            ENTITIES.register("summoned_rapier", () -> EntityType.Builder.<SummonedRapierEntity>of(SummonedRapierEntity::new, MobCategory.MISC)
                    .sized(1f, 1f)
                    .clientTrackingRange(64)
                    .build(ResourceLocation.fromNamespaceAndPath(IronsSpellbooks.MODID, "summoned_rapier").toString()));

    public static final RegistryObject<EntityType<IceSpiderEntity>> ICE_SPIDER =
            ENTITIES.register("ice_spider", () -> EntityType.Builder.<IceSpiderEntity>of(IceSpiderEntity::new, MobCategory.MONSTER)
                    .sized(1.75f, 1.9f)
                    .clientTrackingRange(64)
                    .build(ResourceLocation.fromNamespaceAndPath(IronsSpellbooks.MODID, "ice_spider").toString()));
    ...
    public static final RegistryObject<EntityType<IceTombEntity>> ICE_TOMB =
            ENTITIES.register("ice_tomb", () -> EntityType.Builder.<IceTombEntity>of(IceTombEntity::new, MobCategory.MISC)
                    .sized(1, 2.2f)
                    .clientTrackingRange(64)
                    .build(ResourceLocation.fromNamespaceAndPath(IronsSpellbooks.MODID, "ice_tomb").toString()));

    public static final RegistryObject<EntityType<Snowball>> SNOWBALL =
            ENTITIES.register("snowball", () -> EntityType.Builder.<Snowball>of(Snowball::new, MobCategory.MISC)
                    .sized(0.75F, 0.75F)
                    .clientTrackingRange(64)
                    .build(ResourceLocation.fromNamespaceAndPath(IronsSpellbooks.MODID, "snowball").toString()));

    public static final RegistryObject<EntityType<FrostField>> FROST_FIELD =
