...
public class EntityRegistry {
    ...
    public static final Supplier<EntityType<SpectralHammer>> SPECTRAL_HAMMER =
    ...
    public static final Supplier<EntityType<MagicMissileProjectile>> MAGIC_MISSILE_PROJECTILE =
    ...
    public static final Supplier<EntityType<ConeOfColdProjectile>> CONE_OF_COLD_PROJECTILE =
    ...
    public static final Supplier<EntityType<BloodSlashProjectile>> BLOOD_SLASH_PROJECTILE =
    ...
    public static final Supplier<EntityType<ElectrocuteProjectile>> ELECTROCUTE_PROJECTILE =
    ...
    public static final Supplier<EntityType<FireboltProjectile>> FIREBOLT_PROJECTILE =
    ...
    public static final Supplier<EntityType<IcicleProjectile>> ICICLE_PROJECTILE =
    ...
    public static final Supplier<EntityType<FireBreathProjectile>> FIRE_BREATH_PROJECTILE =
    ...
    public static final Supplier<EntityType<DragonBreathProjectile>> DRAGON_BREATH_PROJECTILE =
    ...
    public static final Supplier<EntityType<DebugWizard>> DEBUG_WIZARD =
    ...
    public static final Supplier<EntityType<SummonedHorse>> SPECTRAL_STEED =
    ...
    public static final Supplier<EntityType<WallOfFireEntity>> WALL_OF_FIRE_ENTITY =
    ...
    public static final Supplier<EntityType<SummonedVex>> SUMMONED_VEX =
    ...
    public static final Supplier<EntityType<PyromancerEntity>> PYROMANCER =
    ...
    public static final Supplier<EntityType<CryomancerEntity>> CRYOMANCER =
    ...
    public static final Supplier<EntityType<LightningLanceProjectile>> LIGHTNING_LANCE_PROJECTILE =
    ...
    public static final Supplier<EntityType<NecromancerEntity>> NECROMANCER =
    ...
    public static final Supplier<EntityType<SummonedZombie>> SUMMONED_ZOMBIE =
    ...
    public static final Supplier<EntityType<SummonedSkeleton>> SUMMONED_SKELETON =
    ...
    public static final Supplier<EntityType<ExtendedWitherSkull>> WITHER_SKULL_PROJECTILE =
    ...
    public static final Supplier<EntityType<MagicArrowProjectile>> MAGIC_ARROW_PROJECTILE =
    ...
    public static final Supplier<EntityType<CreeperHeadProjectile>> CREEPER_HEAD_PROJECTILE =
    ...
    public static final Supplier<EntityType<FrozenHumanoid>> FROZEN_HUMANOID =
    ...
    public static final Supplier<EntityType<SmallMagicFireball>> SMALL_FIREBALL_PROJECTILE =
    ...
    public static final Supplier<EntityType<MagicFireball>> MAGIC_FIREBALL =
    ...
    public static final Supplier<EntityType<SummonedPolarBear>> SUMMONED_POLAR_BEAR =
    ...
    public static final Supplier<EntityType<DeadKingBoss>> DEAD_KING =
    ...
    public static final Supplier<EntityType<DeadKingCorpseEntity>> DEAD_KING_CORPSE =
    ...
    public static final Supplier<EntityType<CatacombsZombie>> CATACOMBS_ZOMBIE =
...
//    public static final Supplier<EntityType<CatacombsSkeletonHorse>> CATACOMBS_SKELETON_HORSE =
...
//                    .build(new ResourceLocation(IronsSpellbooks.MODID, "catacombs_skeleton_horse").toString()));
    ...
    public static final Supplier<EntityType<ArchevokerEntity>> ARCHEVOKER =
    ...
    public static final Supplier<EntityType<MagehunterVindicator>> MAGEHUNTER_VINDICATOR =
    ...
    public static final Supplier<EntityType<KeeperEntity>> KEEPER =
    ...
    public static final Supplier<EntityType<VoidTentacle>> SCULK_TENTACLE =
    ...
    public static final Supplier<EntityType<IceBlockProjectile>> ICE_BLOCK_PROJECTILE =
    ...
    public static final Supplier<EntityType<PoisonCloud>> POISON_CLOUD =
    ...
    public static final Supplier<EntityType<Sunbeam>> SUNBEAM =
    ...
    public static final Supplier<EntityType<DragonBreathPool>> DRAGON_BREATH_POOL =
    ...
    public static final Supplier<EntityType<PoisonBreathProjectile>> POISON_BREATH_PROJECTILE =
    ...
    public static final Supplier<EntityType<PoisonArrow>> POISON_ARROW =
    ...
    public static final Supplier<EntityType<SmallMagicArrow>> SMALL_MAGIC_ARROW =
    ...
    public static final Supplier<EntityType<PoisonSplash>> POISON_SPLASH =
    ...
    public static final Supplier<EntityType<AcidOrb>> ACID_ORB =
    ...
    public static final Supplier<EntityType<RootEntity>> ROOT =
    ...
    public static final Supplier<EntityType<BloodNeedle>> BLOOD_NEEDLE =
    ...
    public static final Supplier<EntityType<FireField>> FIRE_FIELD =
    ...
    public static final Supplier<EntityType<Comet>> COMET =
    ...
    public static final Supplier<EntityType<TargetedAreaEntity>> TARGET_AREA_ENTITY =
    ...
    public static final Supplier<EntityType<HealingAoe>> HEALING_AOE =
    ...
    public static final Supplier<EntityType<EarthquakeAoe>> EARTHQUAKE_AOE =
    ...
    public static final Supplier<EntityType<PriestEntity>> PRIEST =
    ...
    public static final Supplier<EntityType<VisualFallingBlockEntity>> FALLING_BLOCK =
    ...
    public static final Supplier<EntityType<GuidingBoltProjectile>> GUIDING_BOLT =
    ...
    public static final Supplier<EntityType<GustCollider>> GUST_COLLIDER =
    ...
    public static final Supplier<EntityType<ChainLightning>> CHAIN_LIGHTNING =
    ...
    public static final Supplier<EntityType<RayOfFrostVisualEntity>> RAY_OF_FROST_VISUAL_ENTITY =
    ...
    public static final Supplier<EntityType<EldritchBlastVisualEntity>> ELDRITCH_BLAST_VISUAL_ENTITY =
    ...
    public static final Supplier<EntityType<DevourJaw>> DEVOUR_JAW =
    ...
    public static final Supplier<EntityType<FireflySwarmProjectile>> FIREFLY_SWARM =
    ...
    public static final Supplier<EntityType<FlameStrike>> FLAME_STRIKE =
    ...
    public static final Supplier<EntityType<ArrowVolleyEntity>> ARROW_VOLLEY_ENTITY =
    ...
    public static final Supplier<EntityType<StompAoe>> STOMP_AOE =
    ...
    public static final Supplier<EntityType<LightningStrike>> LIGHTNING_STRIKE =
    ...
    public static final Supplier<EntityType<ApothecaristEntity>> APOTHECARIST =
    ...
    public static final Supplier<EntityType<EchoingStrikeEntity>> ECHOING_STRIKE =
    ...
    public static final Supplier<EntityType<CultistEntity>> CULTIST =
    ...
    public static final Supplier<EntityType<BallLightning>> BALL_LIGHTNING =
