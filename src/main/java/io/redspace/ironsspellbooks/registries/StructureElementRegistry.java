...
public class StructureElementRegistry {
    ...
    public static final DeferredRegister<StructurePoolElementType<?>> STRUCTURE_POOL_ELEMENT_DEFERRED_REGISTER = DeferredRegister.create(Registry.STRUCTURE_POOL_ELEMENT_REGISTRY, IronsSpellbooks.MODID);
