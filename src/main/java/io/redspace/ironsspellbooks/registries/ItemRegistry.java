...
public class ItemRegistry {
    ...
    public static final DeferredHolder<Item, Item> ICE_GREATSWORD = ITEMS.register("need_a_better_name", () -> new ExtendedSwordItem(ExtendedWeaponTier.ICE_GREATSWORD, ItemPropertiesHelper.equipment().attributes(ExtendedSwordItem.createAttributes(ExtendedWeaponTier.ICE_GREATSWORD)).rarity(Rarity.RARE).fireResistant()));
