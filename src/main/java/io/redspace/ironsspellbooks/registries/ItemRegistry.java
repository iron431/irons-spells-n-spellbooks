...
//    public static final RegistryObject<Item> FURLED_MAP = ITEMS.register("furled_map", () -> new Item((new Item.Properties()).tab(SpellbookModCreativeTabs.SPELL_MATERIALS_TAB)));
