...
public class SchoolRegistry {
    ...
    public static final Supplier<IForgeRegistry<SchoolType>> REGISTRY = SCHOOLS.makeRegistry(() -> new RegistryBuilder<SchoolType>().hasTags().disableSaving().disableOverrides());
