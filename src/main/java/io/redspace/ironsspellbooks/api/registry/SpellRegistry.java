...
public class SpellRegistry {
    ...
    public static final Supplier<IForgeRegistry<AbstractSpell>> REGISTRY = SPELLS.makeRegistry(() -> new RegistryBuilder<AbstractSpell>().hasTags().disableSaving().disableOverrides());
...
//    public static final RegistryObject<AbstractSpell> GRAVITY_FISSURE = registerSpell(new GravityFissureSpell());
    ...
    public static final RegistryObject<AbstractSpell> FIRE_ARROW_SPELL = registerSpell(new FireArrowSpell());
    public static final RegistryObject<AbstractSpell> RAISE_HELL_SPELL = registerSpell(new RaiseHellSpell());
    ...
    public static final RegistryObject<AbstractSpell> ICE_SPIKES_SPELL = registerSpell(new IceSpikesSpell());
    public static final RegistryObject<AbstractSpell> ICE_TOMB_SPELL = registerSpell(new IceTombSpell());
    public static final RegistryObject<AbstractSpell> SNOWBALL_SPELL = registerSpell(new SnowballSpell());
    public static final RegistryObject<AbstractSpell> FROSTBITE_SPELL = registerSpell(new FrostbiteSpell());
    public static final RegistryObject<AbstractSpell> BLIZZARD_SPELL = registerSpell(new BlizzardSpell());
    ...
    public static final RegistryObject<AbstractSpell> VOLT_STRIKE_SPELL = registerSpell(new VoltStrikeSpell());
    ...
    public static final RegistryObject<AbstractSpell> TOUCH_DIG = registerSpell(new TouchDigSpell());
    ...
    public static final RegistryObject<AbstractSpell> POCKET_DIMENSION_SPELL = registerSpell(new PocketDimensionSpell());
}
