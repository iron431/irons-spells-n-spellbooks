...
public class ArcaneSalvageItem extends Item {
    private static final net.minecraft.network.chat.Component description = Component.translatable("item.irons_spellbooks.arcane_salvage_desc").withStyle(ChatFormatting.GRAY);
