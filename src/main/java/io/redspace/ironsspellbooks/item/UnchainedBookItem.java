...
public class UnchainedBookItem extends ReadableLoreItem implements IBackwardsCompatDefaultNbtItem {
...
//    ), true);
    public static final List<Component> CONTENTS = List.of(ONE, TWO);
