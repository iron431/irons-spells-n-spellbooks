    ...
    public static void onChatReceived(ClientChatReceivedEvent event) {
        ...
        if (event.getMessage().contains(Component.literal("waving"))) {
            ...
            if (animation != null) {
                ...
                animation.setAnimation(new KeyframeAnimationPlayer((KeyframeAnimation) PlayerAnimationRegistry.getAnimation(ResourceLocation.fromNamespaceAndPath(IronsSpellbooks.MODID, "waving"))));
