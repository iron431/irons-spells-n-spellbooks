...
import io.redspace.ironsspellbooks.entity.spells.thunderwave.ThunderwaveProjectileRenderer;
...
import io.redspace.ironsspellbooks.particle.TintedBubblePopParticle;
...
//        EntityRenderer<? extends LivingEntity> genericRender = event.getRenderer()
    ...
    public static void rendererRegister(EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerEntityRenderer(EntityRegistry.THUNDERWAVE_PROJECTILE.get(), NoopRenderer::new);
        ...
        event.registerEntityRenderer(EntityRegistry.THUNDERWAVE_PROJECTILE.get(), ThunderwaveProjectileRenderer::new);
