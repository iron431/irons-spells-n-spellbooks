...
import io.redspace.ironsspellbooks.entity.spells.FireballRenderer;
...
//        EntityRenderer<? extends LivingEntity> genericRender = event.getRenderer()
    ...
    public static void rendererRegister(EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerEntityRenderer(EntityRegistry.FIREBOLT_PROJECTILE.get(), FireballRenderer::new);
        ...
        event.registerEntityRenderer(EntityRegistry.MAGIC_FIREBALL.get(), FireballRenderer::new);
    ...
    public static void clientSetup(final FMLClientSetupEvent e) {
        //Item Properties
        e.enqueueWork(() -> ItemProperties.register(ItemRegistry.WAYWARD_COMPASS.get(), new ResourceLocation("angle"), new CompassItemPropertyFunctionBackport((level, itemStack, entity) -> WaywardCompass.getCatacombsLocation(entity, itemStack.getOrCreateTag()))));
