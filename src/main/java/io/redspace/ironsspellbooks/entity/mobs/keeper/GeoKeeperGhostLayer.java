...
//        model.topLevelBones.forEach((b) -> {
//            if (b != null && !b.name.equals("body") ) b.setScale(.65f, .65f, .65f);
//        });
        this.getRenderer().render(
                this.getEntityModel().getModel(KeeperModel.modelResource),
                entityLivingBaseIn, partialTicks, renderType, matrixStackIn, bufferIn,
                vertexconsumer, packedLightIn, OverlayTexture.NO_OVERLAY, .045f, .045f, .05f, 1f
        );
