...
public class FireBossMusicHandler implements IMusicHandler {
    ...
    Instrument[][] MUSIC = {
            ...
            /*3*/{/*Instrument.BELLS_A,*/ Instrument.DRUMS, Instrument.BACKTRACK, Instrument.MELODY_A},
            ...
            /*10*/{/*Instrument.BACKTRACK*/},
            /*11*/{/*Instrument.DRUMS,*/ Instrument.BACKTRACK, Instrument.MELODY_A},
            /*12*/{/*Instrument.DRUMS,*/ Instrument.BACKTRACK},
            /*13*/{Instrument.BELLS_B, Instrument.DRUMS, Instrument.BACKTRACK, Instrument.MELODY_A},
            /*14*/{Instrument.DRUMS, Instrument.BACKTRACK},
            /*15*/{Instrument.BELLS_B, /*Instrument.DRUMS, Instrument.BACKTRACK,*/ Instrument.MELODY_B}
    };
