package io.redspace.ironsspellbooks.entity.cone_of_cold;
...
public class ConeOfColdProjectile extends AbstractConeProjectile {
    ...
    protected void onHitEntity(EntityHitResult entityHitResult) {
        ...
        DamageSources.applyDamage(entity, damage, SpellType.CONE_OF_COLD_SPELL.getDamageSource(this, getOwner()), SchoolType.ICE);
