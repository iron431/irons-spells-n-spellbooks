...
@OnlyIn(Dist.CLIENT)
public class SuspendedBlockRenderer extends EntityRenderer<SuspendedBlockEntity> {
    private final BlockRenderDispatcher dispatcher;

    public SuspendedBlockRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
        this.shadowRadius = 0.5F;
        this.dispatcher = pContext.getBlockRenderDispatcher();
    }

    public void render(SuspendedBlockEntity entity, float pEntityYaw, float pPartialTicks, @NotNull PoseStack pMatrixStack, @NotNull MultiBufferSource pBuffer, int pPackedLight) {
    ...
    public @NotNull ResourceLocation getTextureLocation(@NotNull SuspendedBlockEntity pEntity) {
