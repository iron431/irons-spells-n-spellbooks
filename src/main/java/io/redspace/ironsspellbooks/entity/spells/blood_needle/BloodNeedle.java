...
public class BloodNeedle extends AbstractMagicProjectile {
    ...
    protected void onHitEntity(EntityHitResult entityHitResult) {
        ...
        boolean hit = DamageSources.applyDamage(entityHitResult.getEntity(), getDamage(), IronsSpellRegistry.BLOOD_NEEDLES_SPELL.get().getDamageSource(this, getOwner()), SchoolType.BLOOD);
