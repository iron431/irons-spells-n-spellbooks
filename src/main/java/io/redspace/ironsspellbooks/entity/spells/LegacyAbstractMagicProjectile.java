...
public abstract class LegacyAbstractMagicProjectile extends Projectile implements AntiMagicSusceptible, IEntityWithComplexSpawn {
    private static final EntityDataAccessor<Boolean> DATA_CURSOR_HOMING = SynchedEntityData.defineId(LegacyAbstractMagicProjectile.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Integer> DATA_RICOCHET = SynchedEntityData.defineId(LegacyAbstractMagicProjectile.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Integer> DATA_PIERCE_LEVEL = SynchedEntityData.defineId(LegacyAbstractMagicProjectile.class, EntityDataSerializers.INT);
    ...
    public LegacyAbstractMagicProjectile(EntityType<? extends Projectile> pEntityType, Level pLevel) {
    ...
    /**
     * Useful for {@link Projectile#onHit(HitResult)}, will discard if block impact, or {@link LegacyAbstractMagicProjectile#consumeEntityImpact(EntityHitResult hit, boolean discardWhenExhausted)} on entity impact
     */
    @UnstableApi
