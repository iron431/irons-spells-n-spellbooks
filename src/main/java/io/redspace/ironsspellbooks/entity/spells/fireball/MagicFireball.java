        ...
        if (!this.level.isClientSide) {
            ...
            for (Entity entity : entities) {
                ...
                if (distance < explosionRadius * explosionRadius && canHitEntity(entity)) {
                    ...
                    DamageSources.applyDamage(entity, damage, IronsSpellRegistry.FIREBALL_SPELL.get().getDamageSource(this, getOwner()), SchoolType.FIRE);
                }
            }
            boolean flag = net.minecraftforge.event.ForgeEventFactory.getMobGriefingEvent(this.level, this.getOwner());
            this.level.explode(null, IronsSpellRegistry.FIREBALL_SPELL.get().getDamageSource(this, getOwner()), null, this.getX(), this.getY(), this.getZ(), (float) this.getExplosionRadius(), flag, flag ? Explosion.BlockInteraction.DESTROY : Explosion.BlockInteraction.NONE);
            this.discard();
        }
    }
