...
public class PoisonBreathProjectile extends AbstractConeProjectile {
    ...
    protected void onHitEntity(EntityHitResult entityHitResult) {
        ...
        if (DamageSources.applyDamage(entity, damage, SkillRegistry.POISON_BREATH_SPELL.get().getDamageSource(this.level(), this, getOwner())) && entity instanceof LivingEntity livingEntity)
