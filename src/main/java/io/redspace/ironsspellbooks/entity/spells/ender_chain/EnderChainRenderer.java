...
public class EnderChainRenderer extends EntityRenderer<EnderChain> {
    private static final ResourceLocation CHAIN_TEXTURE = IronsSpellbooks.id("textures/entity/ender_chain.png");
    ...
    @Override
    public void render(@NotNull EnderChain entity, float entityYaw, float partialTick, @NotNull PoseStack poseStack, @NotNull MultiBufferSource bufferSource, int packedLight) {
        ...
        renderChainBetween(Vec3.ZERO, targetPos, poseStack, bufferSource);
    ...
    public static void renderChainBetween(Vec3 start, Vec3 to, PoseStack poseStack, MultiBufferSource multiBufferSource) {
        ...
        SpellRenderingHelper.drawQuad(Vec3.ZERO, new Vec3(0, 0, distance), 1, 0, pose, consumer, 255, 255, 255, 255, 0, distance);
        SpellRenderingHelper.drawQuad(Vec3.ZERO, new Vec3(0, 0, distance), 0, 1, pose, consumer, 255, 255, 255, 255, 0, distance);
