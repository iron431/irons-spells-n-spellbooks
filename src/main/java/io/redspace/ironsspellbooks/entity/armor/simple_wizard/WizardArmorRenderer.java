...
public class WizardArmorRenderer extends GeoArmorRenderer<WizardArmorItem> {
    ...
    protected void fitToBiped() {
        ...
        //irons_spellbooks.LOGGER.debug("WizardArmorRenderer.fitToBiped all bones: {}", WizardArmorModel.listOfBonesToString(getGeoModelProvider().getAnimationProcessor().getModelRendererList()));
    }
