package io.redspace.ironsspellbooks.entity.fire_breath;
...
public class FireBreathProjectile extends AbstractConeProjectile {
    ...
    protected void onHitEntity(EntityHitResult entityHitResult) {
        ...
        DamageSources.applyDamage(entity, damage, SpellType.FIRE_BREATH_SPELL.getDamageSource(this, getOwner()), SchoolType.FIRE);
