...
public class ChargeSpellLayer {
    // fixme skillcasting: generify this and provide skill hooks?
    //  probably not, just reimplement for spellbooks only
...
//        if (spellId.equals(SkillRegistry.LIGHTNING_LANCE_SPELL.get().getSpellId())) {
...
//                if (!spellId.equals("irons_spellbooks:lightning_lance")) {
