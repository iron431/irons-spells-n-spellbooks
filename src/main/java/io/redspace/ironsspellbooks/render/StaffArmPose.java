...
public class StaffArmPose {
    @OnlyIn(Dist.CLIENT)
    public static HumanoidModel.ArmPose STAFF_ARM_POS = HumanoidModel.ArmPose.EMPTY;/*HumanoidModel.ArmPose.create("IRONS_SPELLBOOKS_STAFF", false, (model, entity, arm) -> (arm == HumanoidArm.RIGHT ? model.rightArm : model.leftArm).xRot =
