...
public class SpellRenderingHelper {
    ...
    public static void renderSpellHelper(MagicData spellData, LivingEntity castingMob, PoseStack poseStack, MultiBufferSource bufferSource, float partialTicks) {
