    ...
    public void render(ForgeGui gui, PoseStack poseStack, float partialTick, int screenWidth, int screenHeight) {
        ...
        for (int i = 0; i < locations.length; i++) {
            ...
            if (spell != null) {
                ...
                var spellInfo = Component.translatable("ui." + IronsSpellbooks.MODID + ".lvl").withStyle(ChatFormatting.WHITE)
                        .append(Component.literal(" " + currentSpell.getLevel() + "  ").withStyle(ChatFormatting.RED))
                        .append(Component.translatable("ui." + IronsSpellbooks.MODID + ".cost").withStyle(ChatFormatting.WHITE))
